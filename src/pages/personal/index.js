...
const Page = () => {
  ...
  const defaultRow = { id: 0, agendamento: '', descricao: '', status: '', cpf_paciente: '', cpf_medico: '', created_at: '', updated_at: '' };
  ...
  const fetchData = useCallback(async () => {
    setList(await http(`${DEFAULT.ENDPOINT.CONSULTA}/${cpf}`, { method: DEFAULT.METHOD.GET }));
  }, [http, setList]);
