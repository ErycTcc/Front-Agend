...
const Page = () => {
  ...
  const defaultRow = { cpf: 0, nome: '', telefone: '', genero: '', crm: '', endereco_id: 0, tipo_consulta_id: 0, usuario_sistema_id: 0, created_at: '', updated_at: '' };
  ...
  const fetchData = useCallback(async () => {
    setList(await http(DEFAULT.ENDPOINT.MEDICO, { method: DEFAULT.METHOD.GET }));
  }, [http, setList]);
