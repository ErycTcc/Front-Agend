...
const Page = () => {
  ...
  const defaultRow = { id: 0, descricao: '', created_at: '', updated_at: '' };
  ...
  const fetchData = useCallback(async () => {
    setList(await http(DEFAULT.ENDPOINT.ESPECIALIZACAO, { method: DEFAULT.METHOD.GET }));
  }, [http, setList]);
